...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Bolos, doces, mini salgados e kits de festa feitos com técnica e ingredientes selecionados." },
      { name: "author", content: "Grand Coffee" },
      { property: "og:title", content: "Grand Coffee Confeitaria — Artesanal em São Luís" },
      { property: "og:description", content: "Bolos, doces, mini salgados e kits de festa feitos com técnica e ingredientes selecionados." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Grand Coffee Confeitaria — Artesanal em São Luís" },
      { name: "twitter:description", content: "Bolos, doces, mini salgados e kits de festa feitos com técnica e ingredientes selecionados." },
